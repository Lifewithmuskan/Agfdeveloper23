...
const Uttarakhand = () => {
  const uttarakhandProjects = [
    { 
      name: 'Amoda Sari – Premium Villas (Globe Stay)', 
      href: '/amodasari', 
      image: '/images/amoda-sari.jpg' // <-- replace with actual image path
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl pt-6 md:text-6xl font-bold mb-6 mt-6">
              Uttarakhand <span className="text-gold-400">Project</span>
            </h1>
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Discover premium living in the serene beauty of Uttarakhand.
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {uttarakhandProjects.map((project, idx) => (
              <div
                key={idx}
