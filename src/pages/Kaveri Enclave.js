    ...
    const heroSlides = useMemo(() => [
        {
            ...
            subtitle: 'Build your dream farmhouse in a prime location'
        },
        {
            ...
            subtitle: 'High-potential plots near Noida International Airport'
        },
        {
            image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1920&h=1080&fit=crop&q=80&auto=format',
            title: 'Seamless Connectivity',
            subtitle: 'Just 5 minutes from major infrastructure'
        }
    ], []);

    const pricingCards = [
        {
            img: "/images/farmhouse.jpg",
            price: "₹60,000",
            label: "Per Sq. Yd.",
            title1: "",
        ...
        <div className="min-h-screen bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="text-gold-200 font-medium">Premium Farmhouse Community</span>
                                </motion.div>
                                ...
                                >
                                    Discover Kaveri Enclave, a premium farmhouse project just 5 minutes from Noida International Airport,
                                    offering spacious freehold plots starting at 1210 sq. yards with immediate registry and possession.
                                </motion.p>
                                ...
                                >
                                    ...
                                    <div className="text-center">
                                        <div className="text-3xl font-bold text-gold-400 mb-1">30 ft.</div>
                                        <div className="text-sm text-gray-300">Main Road</div>
                                    </div>
                                    <div className="text-center">
                            ...
                            >
                                <div className="space-y-4">
                                    {[
                                        { icon: Award, title: "Prime Location", desc: "5 mins from Airport" },
                                        { icon: Sparkles, title: "Secure Ownership", desc: "Freehold land" },
                                        { icon: TrendingUp, title: "High ROI", desc: "10% guaranteed returns" },
            ...
            <section id="about" className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-6">About Kaveri Enclave</h2>
                        <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                            Kaveri Enclave is a premium farmhouse project located just 5 minutes from Noida International Airport,
                            offering legal freehold land with farm sizes starting from 1210 sq. yards. Each plot includes a boundary
                            wall and security gate, with immediate registry, mutation, and possession available.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        >
                            <div className="text-3xl font-bold text-primary-600 mb-2">1210</div>
                        ...
                        <motion.div
                            ...
                            className="text-center bg-gradient-to-br from-primary-50 to-gold-50 p-6 rounded-xl"
                        >
                            <div className="text-3xl font-bold text-primary-600 mb-2">30 ft.</div>
                            <div className="text-gray-600">Main Road</div>
                        </motion.div>
                        ...
                        >
                            <div className="grid grid-cols-2 gap-4">
                                <img
                                    ...
                                    alt="Kaveri Enclave Highlight 1"
                                ...
                                <img
                                    ...
                                    alt="Kaveri Enclave Highlight 2"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Invest in your dream farmhouse with our competitive pricing and flexible payment plans
                        </p>
                    </motion.div>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Enjoy a secure and luxurious lifestyle with our comprehensive amenities
                        </p>
                    </motion.div>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Discover the strategic location with excellent connectivity to Noida International Airport
                        </p>
                    </motion.div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Strategically located just 5 minutes from Noida International Airport
                        </p>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-700 mb-8">
                            Secure your farmhouse plot today! Let's connect!
                        </p>
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { label: 'Plot Cost (1210 sq. yd.)', value: '₹7,26,00,000' },
                                    ...
                                    <div className="flex justify-between items-center py-3 border-t-2 border-primary-200 text-lg font-bold">
                                        ...
                                        <span className="text-primary-600">₹7,33,00,000</span>
                                    </div>
                                </div>
                            </div>
                            <div className="mb-8">
