        ...
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                >
                                    Discover Royal Empire, a prestigious plotted development in Solra, Haryana,
            ...
            <section id="about" className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-6">About Royal Empire</h2>
                        <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                            Royal Empire is a prestigious residential plotted development in Solra, Haryana,
