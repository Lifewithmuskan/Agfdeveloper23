        ...
        <div className="min-h-screen bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="text-gold-200 font-medium">Premium Plotted Community</span>
                                </motion.div>
                                ...
                                >
                                    Discover Adityam Heritage Phase-2, a premium plotted development in Solara, Haryana,
                                    spanning 18388 sq. yd. with 12865 sq. yd. of plot area, 4973 sq. yd. of road area,
                                    and 550 sq. yd. of park area, offering exceptional residential and investment opportunities.
                                </motion.p>
                                ...
                                >
                                    <div className="text-center">
                                        <div className="text-3xl font-bold text-gold-400 mb-1">12865</div>
                                        <div className="text-sm text-gray-300">Plot Sq. Yd.</div>
                                    </div>
                                    <div className="text-center">
                                        <div className="text-3xl font-bold text-gold-400 mb-1">18388</div>
                                        <div className="text-sm text-gray-300">Total Sq. Yd.</div>
                                    </div>
                                    <div className="text-center">
                            ...
                            >
                                <div className="space-y-4">
                                    {[
                                        { icon: Award, title: "Prime Location", desc: "Solara, Haryana" },
                                        { icon: Sparkles, title: "Secure Ownership", desc: "Freehold plots" },
                                        { icon: TrendingUp, title: "High ROI", desc: "11% guaranteed returns" },
            ...
            <section id="about" className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-6">About Adityam Heritage</h2>
                        <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                            Adityam Heritage Phase-2 is a premium plotted development in Solara, Haryana, spanning 18388 sq. yd.
                            with 12865 sq. yd. of plot area, 4973 sq. yd. of road area, and 550 sq. yd. of park area. Designed for
                            residential development and high investment potential, it offers secure freehold plots with immediate
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        >
                            <div className="text-3xl font-bold text-primary-600 mb-2">12865</div>
                        ...
                        <motion.div
                            ...
                            className="text-center bg-gradient-to-br from-primary-50 to-gold-50 p-6 rounded-xl"
                        >
                            <div className="text-3xl font-bold text-primary-600 mb-2">18388</div>
                        ...
                        >
                            ...
                            <div className="text-gray-600">Park Sq. Yd.</div>
                        </motion.div>
                        ...
                        >
                            <div className="grid grid-cols-2 gap-4">
                                <img
                                    ...
                                    alt="Adityam Heritage Highlight 1"
                                ...
                                <img
                                    ...
                                    alt="Adityam Heritage Highlight 2"
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { label: 'Plot Cost (100 sq. yd.)', value: '₹48,00,000' },
                                    ...
                                    <div className="flex justify-between items-center py-3 border-t-2 border-primary-200 text-lg font-bold">
                                        ...
                                        <span className="text-primary-600">₹51,50,000</span>
                                    </div>
                                </div>
                            </div>
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="border border-primary-200 rounded-lg p-4 bg-primary-50">
                                        <h5 className="font-semibold text-primary-700 mb-2">35:65 Plan</h5>
                                        <div className="text-sm space-y-1">
                                            <div>• 35% on booking</div>
                                            <div>• 65% on possession</div>
...
export default AdityamHeritage;