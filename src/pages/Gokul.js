    ...
    const heroSlides = useMemo(() => [
        {
            ...
            title: 'Secure Living',
            subtitle: 'Experience safe and modern plotted development'
        },
        {
        ...
        <div className="min-h-screen bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="text-gold-200 font-medium">Prestigious Plotted Community</span>
                                </motion.div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        <br />
                                        <span className="text-white">Royal Empire</span>
                                    </motion.h1>
                                ...
                                >
                                    Discover Gokul - Royal Empire, a prestigious plotted development in Solra, Haryana,
                                    offering secure freehold plots starting at 111 sq. yards, just 5 minutes from Noida International Airport.
                                </motion.p>
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm text-gray-300">Plots</div>
                                    </div>
                                    <div className="text-center">
                                    ...
                                    <div className="text-center">
                                        <div className="text-3xl font-bold text-gold-400 mb-1">2024</div>
            ...
            <section id="about" className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-gray-900 mb-6">About Gokul - Royal Empire</h2>
                        <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                            Gokul - Royal Empire is a prestigious residential plotted development in Solra, Haryana,
                            spanning 3 acres with secure freehold plots starting at 111 sq. yards. Located just 5 minutes from
                            Noida International Airport, it offers immediate registry, mutation, and possession with bank loan options.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        >
                            ...
                            <div className="text-gray-600">Plots</div>
                        </motion.div>
                            ...
                            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                                <div className="bg-gradient-to-r from-primary-600 to-gold-600 p-4">
                                    <h3 className="text-white font-semibold text-lg flex items-center">
                                        ...
                                        Gokul - Royal Empire - Solra, Haryana
                                    </h3>
                                </div>
                                ...
                                <div className="h-[600px] relative overflow-hidden">
                                    <img
                                        ...
                                        alt="Solra Haryana Map Location"
            ...
            <section className="py-16 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Strategically located in Solra, Haryana, just 5 minutes from Noida International Airport
                        </p>
                    </motion.div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    ...
                    >
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-8">
                                <h4 className="text-xl font-bold text-gray-900 mb-4">Cost Breakdown (111 sq. yd. example)</h4>
                                <div className="space-y-3">
                                    {[
                                        { label: 'Plot Cost (111 sq. yd.)', value: '₹55,50,000' },
                                        { label: 'Development Charges', value: '₹3,00,000' },
                                        { label: 'Club Membership', value: '₹1,50,000' },
                                    ...
                                    <div className="flex justify-between items-center py-3 border-t-2 border-primary-200 text-lg font-bold">
                                        ...
                                        <span className="text-primary-600">₹60,00,000</span>
                                    </div>
                                </div>
                            </div>
